...
if __name__ == "__main__":
    # Initialize environment in continuous mode
    ...
    while not quit:
        ...
        while True:
            # Preprocess frame
            frame_tensor = torch.tensor(s, dtype=torch.float32).permute(2, 0, 1).unsqueeze(0) / 255.0
            ...
            with torch.no_grad():
                ...
                # Clamp values to safe ranges: steer [-1, 1], gas [0, 1], brake [0, 1]
